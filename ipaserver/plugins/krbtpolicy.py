...
class krbtpolicy(baseldap.LDAPObject):
    ...
    takes_params = (
        ...
        Int('krbmaxticketlife?',
            cli_name='maxlife',
            label=_('Max life'),
            doc=_('Default Maximum ticket life (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxticketlifeotp?',
            cli_name='maxlife_otp',
            label=_('Max life (OTP)'),
            doc=_('Maximum ticket life for OTP (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxticketliferadius?',
            cli_name='maxlife_radius',
            label=_('Max life (RADIUS)'),
            doc=_('Maximum ticket life for RADIUS (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxticketlifepkinit?',
            cli_name='maxlife_pkinit',
            label=_('Max life (PKINIT)'),
            doc=_('Maximum ticket life for PKINIT (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxticketlifehardened?',
            cli_name='maxlife_hardened',
            label=_('Max life (Hardened)'),
            doc=_('Maximum ticket life for Hardened password (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxrenewableage?',
            cli_name='maxrenew',
            label=_('Max renew'),
            doc=_('Default Maximum renewable age (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxrenewableageotp?',
            cli_name='maxrenew_otp',
            label=_('Max renew (OTP)'),
            doc=_('Maximum renewable age for OTP (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxrenewableageradius?',
            cli_name='maxrenew_radius',
            label=_('Max renew (RADIUS)'),
            doc=_('Maximum renewable age for RADIUS (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxrenewableagepkinit?',
            cli_name='maxrenew_pkinit',
            label=_('Max renew (PKINIT)'),
            doc=_('Maximum renewable age for PKINIT (seconds)'),
            minvalue=1,
        ),
        Int('krbmaxrenewableagehardened?',
            cli_name='maxrenew_hardened',
            label=_('Max renew (Hardened)'),
            doc=_('Maximum renewable age for Hardened passwprd (seconds)'),
            minvalue=1,
        ),
    )
